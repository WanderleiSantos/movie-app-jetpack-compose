package com.wanderlei.movieapp.core.data.remote

import com.wanderlei.movieapp.core.data.remote.response.MovieDetailResponse
...
interface MovieService {
    ...
    suspend fun getMoviesSimilar(@Path("movie_id") movieId: Int, @Query("page") page: Int): MovieResponse
}