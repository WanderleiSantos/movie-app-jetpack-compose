...
import com.wanderlei.movieapp.movie_detail_feature.data.mapper.toMovie
import com.wanderlei.movieapp.ui.theme.black
import com.wanderlei.movieapp.ui.theme.white
import com.wanderlei.movieapp.ui.theme.yellow
    ...
    Box(
        ...
        Column(
            ...
            Row(
                ...
                IconButton(
                    onClick = {
                        movieDetails?.toMovie()?.let { movie -> onAddFavorite(movie) }
                    }
                ) {
                    Icon(
